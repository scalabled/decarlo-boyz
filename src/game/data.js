  ...
  carson: {
    ...
    story: [
      ...
      { no: 'CH 2', name: 'Toll Collectors', zone: 'NORTH SHORE SLIP', teaser: "Somebody's charging for the river.",
        track: 'goons', goal: 5, at: 'dock_north', cash: 1000, respect: 32, unlock: 'flare', difficulty: 1,
      ...
      { no: 'CH 4', name: 'Salvage Rights', zone: 'OHIO CHANNEL', teaser: 'Pull six crates out of the water before they do.',
        track: 'collect', goal: 6, spread: 520, water: true, at: 'lm_point', baseTimer: 150, cash: 1900, respect: 55, unlock: 'speargun', difficulty: 2,
  ...
  aidan: {
    ...
    story: [
      ...
      { no: 'CH 2', name: "Duke's Boys", zone: 'BUTLER STREET', teaser: 'Five men, one wrench.',
        track: 'brawl', goal: 5, at: 'sh_aidan', cash: 1050, respect: 34, unlock: 'nailgun', difficulty: 1,
      ...
      { no: 'CH 4', name: 'The Big Recovery', zone: 'LAWRENCEVILLE', teaser: "Steal back what's yours, one ride at a time.",
        track: 'recover', goal: 3, at: 'sh_aidan', dest: 'sh_aidan', cash: 1800, respect: 55, unlock: 'rivetgun', difficulty: 2,
  ...
  dylan: {
    ...
    story: [
      ...
      { no: 'CH 2', name: 'Package Run', zone: 'GOLDEN TRIANGLE', teaser: 'Four drops, one clock.',
        track: 'collect', goal: 4, spread: 380, at: 'lm_tower', baseTimer: 105, cash: 1100, respect: 34, unlock: 'tackgun', difficulty: 1,
      ...
      { no: 'CH 5', name: 'Air Mail', zone: 'RIVERS FIELD', teaser: 'Beat the flight out of the east field.',
        track: 'timedDeliver', vehType: 'muscle', dest: 'ap_east', baseTimer: 96, cash: 2500, respect: 70, unlock: 'smg', difficulty: 3,
